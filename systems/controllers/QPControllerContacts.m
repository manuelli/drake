...
%       Sdot = 0*S;
    ...
    fc = varargin{3}; % what is this fc? Is it the FootContactBlock???
    ...
    % now we need to actually determine which of these are active and stuff
    ...
    contact_groups = {};
    n_contact_pts = [];
    ind = 1; % what is this referencing???
    ...
    if (obj.use_mex==0 || obj.use_mex==2)
      ...
      % I think that all I need to modify is what these things are . . . 
