...
class ExternalForce(object):
    ...
    def addSubscribers(self):
        ...
        lcmUtils.addSubscriber('RESIDUAL_OBSERVER_STATE', lcmdrc.residual_observer_state_t, self.onResidualObserverState)
    ...
    def publish(self):
        ...
        for key, val in self.externalForces.iteritems():
            ...
            msgContactLocation = lcmdrc.single_contact_filter_estimate_t()
        ...
        if self.options['debug']['publishTrueResidual']:
            ...
            residualMsg = lcmdrc.residual_observer_state_t()
