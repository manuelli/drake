...
namespace residual_detector{
  ...
  std::shared_ptr<DrakeRobotStateWithTorque> RobotStateDecoder::decodeRobotStateMsg(const bot_core::robot_state_t *msg) {
    std::shared_ptr<DrakeRobotStateWithTorque> robot_state(new DrakeRobotStateWithTorque);
